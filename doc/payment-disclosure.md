...
This is an experimental feature.  Enable it by launching `zcashd` with flags:
    ...
    bitzecd -experimentalfeatures -paymentdisclosure -debug=paymentdisclosure -txindex=1

These flags can also be set as options in `bitzec.conf`.
...
Generate a payment disclosure for the first joinsplit, second output (index starts from zero):
    ...
    bitzec-cli z_getpaymentdisclosure 79189528d611e811a1c7bb0358dd31343033d14b4c1e998d7c4799c40f8b652b 0 1 "Hello"
...
To validate the payment disclosure:
    ...
    bitzec-cli z_validatepaymentdisclosure HEXDATA
